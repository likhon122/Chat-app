  ...
  return (
    <div className="relative w-full  sm:max-w-[400px] mx-auto">
      <form onSubmit={handleSubmit} className="flex items-center">
        ...
        <button
          type="submit"
          className="dark:bg-[#3A3B3C] border-r border-y border-[#454647] text-gray-700 dark:text-white dark:hover:bg-[#303031] transition duration-300 px-2 py-[4px] sm:py-[6px] rounded-r-full flex items-center justify-center  hover:bg-gray-300"
        >
          <IoSearch size={20} />
        </button>
      </form>
