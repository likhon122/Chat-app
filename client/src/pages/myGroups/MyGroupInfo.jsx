...
const MyGroupInfo = ({ groupId }) => {
  ...
  return (
    <div className="h-[94.7vh] bg-gray-100 dark:bg-gray-900 p-6 space-y-6">
      {/* Change Group Name */}
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-300 dark:border-gray-700">
        ...
        <div className="flex items-center space-x-4">
          <input
            ...
            className="flex-1 p-2 border border-gray-300 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
          />
          <button
            onClick={handleNameSave}
            className="px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white rounded-md hover:bg-blue-600 dark:hover:bg-blue-700 transition duration-300"
